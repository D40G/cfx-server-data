...
--     exports.DX_API:<function>
--
-- For example:
--		exports.DX_API:GetRoleIdFromRoleName("roleName")
...
-- Usage:
	...
	print("[DX_Perms Example] The roleID for (" .. roleName .. ") is: " .. tostring(roleID));
...
-- Usage:
	...
	print("[DX_Perms Example] Player " .. GetPlayerName(user) .. " has Discord email verified?: " .. tostring(isVerified));
...
-- Usage:
	...
	print("[DX_Perms Example] Player " .. GetPlayerName(user) .. " has Discord email address: " .. tostring(emailAddr));
...
-- Usage:
	...
	print("[DX_Perms Example] Player " .. GetPlayerName(user) .. " has Discord name: " .. tostring(name));
...
-- Usage:
	...
	print("[DX_Perms Example] Guild icon URL is: " .. tostring(icon_URL));
...
-- Usage:
	...
	print("[DX_Perms Example] Guild splash URL is: " .. tostring(splash_URL));
...
-- Usage:
	...
	print("[DX_Perms Example] Guild name is: " .. tostring(guildName));
...
-- Usage:
	...
	print("[DX_Perms Example] Guild description is: " .. tostring(guildDesc));
...
-- Usage:
	...
	print("[DX_Perms Example] Guild member count is: " .. tostring(guildMemCount));
...
-- Usage:
	...
	print("[DX_Perms Example] Guild online member count is: " .. tostring(onlineMemCount));
...
-- Usage:
	...
	print("[DX_Perms Example] Player " .. GetPlayerName(user) .. " has Discord avatar: " .. tostring(avatar));
...
-- Usage:
	...
	print("[DX_Perms Example] Player " .. GetPlayerName(user) .. " has Discord nickname: " .. tostring(nickname));
